...
while (now < till):
    ...
    btst_5min = calls_generator('./data/filters/btst.json','./data/signals/5min.json')
    ...
    btst_15min = calls_generator('./data/filters/btst.json','./data/signals/15min.json')
    ...
    intraday_1min = calls_generator('./data/filters/intraday.json','./data/signals/1min.json')
    ...
    intraday_5min = calls_generator('./data/filters/intraday.json','./data/signals/5min.json')
